...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(home: DemoHome());
  }
}
...
Future<ThumbnailResult> genThumbnail(ThumbnailRequest r) async {
  ...
  if (thumbnailPath == null) {
    completer.completeError("thumbnailPath is null");
        ...
        if (snapshot.hasData) {
          ...
          return Column(
            ...
            children: <Widget>[
              Center(
                child: Text(
                  "Image ${'file size'}: $_dataSize, width:$_width, height:$_height",
                ),
              ),
          ...
          Expanded(
            child: Container(
              ...
              child: Scrollbar(
                child: ListView(
                  shrinkWrap: true,
                  children: <Widget>[_futureImage ?? SizedBox()],
                ),
              ),
            ),
          ),
